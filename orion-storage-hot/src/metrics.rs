...
pub fn init_metrics() {
    // Counters
    let _ = counter!("orion_storage_messages_total");
    let _ = counter!("orion_storage_errors_total");
    let _ = counter!("orion_storage_inserted_total");

    // Histograms
    let _ = histogram!("orion_storage_latency_seconds");
}
